...
const statements = [
  ...
  `ALTER TABLE reservations ADD COLUMN IF NOT EXISTS is_private BOOLEAN NOT NULL DEFAULT FALSE`,
  ...
  `ALTER TABLE manual_events ADD COLUMN IF NOT EXISTS is_private BOOLEAN NOT NULL DEFAULT FALSE`,
  ...
  `ALTER TABLE plays ADD COLUMN IF NOT EXISTS bought BOOLEAN NOT NULL DEFAULT FALSE`,
  `ALTER TABLE manual_plays ADD COLUMN IF NOT EXISTS bought BOOLEAN NOT NULL DEFAULT FALSE`,
